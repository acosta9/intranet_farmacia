 ...
 */
class ProdLaboratorioForm extends BaseProdLaboratorioForm
{
    ...
    $this->setValidators(array(
      ...
      $this->validatorSchema->setPostValidator(
        new sfValidatorAnd(array(
          new sfValidatorDoctrineUnique(array('model' => 'ProdLaboratorio', 'column' => array('nombre')), array(
            'invalid'=> 'Laboratorio ya existente.')),
