 ...
 */
class ProdUnidadForm extends BaseProdUnidadForm
{
    ...
    $this->setValidators(array(
      ...
      $this->validatorSchema->setPostValidator(
        new sfValidatorAnd(array(
          new sfValidatorDoctrineUnique(array('model' => 'ProdUnidad', 'column' => array('nombre')), array(
            'invalid'=> 'Unidad ya existente.')),
