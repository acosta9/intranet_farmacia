...
/**
 * OfertaImg form base class.
 *
 * @method OfertaImg getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseOfertaImgForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('oferta_img[%s]');
