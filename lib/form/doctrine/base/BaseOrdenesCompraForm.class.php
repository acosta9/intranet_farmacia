...
/**
 * OrdenesCompra form base class.
 *
 * @method OrdenesCompra getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseOrdenesCompraForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ordenes_compra[%s]');
