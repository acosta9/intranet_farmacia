...
/**
 * ProdVendidos form base class.
 *
 * @method ProdVendidos getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProdVendidosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('prod_vendidos[%s]');
