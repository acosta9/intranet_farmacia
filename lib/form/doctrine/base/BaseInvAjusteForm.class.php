...
/**
 * InvAjuste form base class.
 *
 * @method InvAjuste getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInvAjusteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inv_ajuste[%s]');
