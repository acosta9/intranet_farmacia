...
abstract class BaseKardexForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fvenc'       => new sfWidgetFormInputText(),
    ));
    ...
    $this->setValidators(array(
      ...
      'concepto'    => new sfValidatorString(array('max_length' => 200)),
      'lote'        => new sfValidatorString(array('max_length' => 200, 'required' => false)),
      'fvenc'       => new sfValidatorString(array('max_length' => 200, 'required' => false)),
    ));
