...
/**
 * DevolverDet form base class.
 *
 * @method DevolverDet getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDevolverDetForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'            => new sfWidgetFormInputHidden(),
      'devolver_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Devolver'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'devolver_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Devolver'))),
    ...
    $this->widgetSchema->setNameFormat('devolver_det[%s]');
