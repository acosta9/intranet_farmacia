...
/**
 * NotaEntrega form base class.
 *
 * @method NotaEntrega getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseNotaEntregaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nota_entrega[%s]');
