...
/**
 * ReciboPagoCompra form base class.
 *
 * @method ReciboPagoCompra getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseReciboPagoCompraForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('recibo_pago_compra[%s]');
