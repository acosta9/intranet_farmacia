...
/**
 * FacturaDet form base class.
 *
 * @method FacturaDet getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseFacturaDetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('factura_det[%s]');
