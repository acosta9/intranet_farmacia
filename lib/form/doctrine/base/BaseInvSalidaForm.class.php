...
/**
 * InvSalida form base class.
 *
 * @method InvSalida getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInvSalidaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inv_salida[%s]');
