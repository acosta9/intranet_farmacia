 ...
 */
class GastosTipoForm extends BaseGastosTipoForm
{
    ...
    $this->setValidators(array(
      ...
      $this->validatorSchema->setPostValidator(
        new sfValidatorAnd(array(
          new sfValidatorDoctrineUnique(array('model' => 'GastosTipo', 'column' => array('nombre')), array(
            'invalid'=> 'Nombre ya existente.')),
