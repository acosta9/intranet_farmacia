 ...
 */
class ReciboPagoCompraFormFilter extends BaseReciboPagoCompraFormFilter
{
  public function configure()
  {
    ...
    $results = Doctrine_Query::create()
      ...
      ->execute();
    foreach ($results as $result) {
        $choices_banco[$result->getId()]=$result["nombre"];
    } 
    ...
    $this->setWidget('banco_id', new sfWidgetFormSelect(array('choices' =>  $choices_banco, 'multiple' => 'multiple')));
    ...
    //$this->widgetSchema['banco_id']->setAttributes(array('class' => 'form-control'));
    ...
    //$this->validatorSchema ['banco_id'] = new sfValidatorPass();
