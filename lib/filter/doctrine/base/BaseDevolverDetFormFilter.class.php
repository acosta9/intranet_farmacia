...
/**
 * DevolverDet filter form base class.
 *
 ...
 */
abstract class BaseDevolverDetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'devolver_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Devolver'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'devolver_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Devolver'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('devolver_det_filters[%s]');
