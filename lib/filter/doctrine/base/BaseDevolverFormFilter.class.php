...
/**
 * Devolver filter form base class.
 *
 ...
 */
abstract class BaseDevolverFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'empresa_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Empresa'), 'add_empty' => true)),
      'deposito_id'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'factura_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Factura'), 'add_empty' => true)),
      'num_nota_credito' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'deposito_id'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'factura_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Factura'), 'column' => 'id')),
      'num_nota_credito' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('devolver_filters[%s]');
