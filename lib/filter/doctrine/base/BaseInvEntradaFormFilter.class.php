...
/**
 * InvEntrada filter form base class.
 *
 ...
 */
abstract class BaseInvEntradaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inv_entrada_filters[%s]');
