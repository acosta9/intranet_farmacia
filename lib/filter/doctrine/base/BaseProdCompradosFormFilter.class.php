...
/**
 * ProdComprados filter form base class.
 *
 ...
 */
abstract class BaseProdCompradosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('prod_comprados_filters[%s]');
