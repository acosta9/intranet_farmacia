...
/**
 * ReciboPagoCompra filter form base class.
 *
 ...
 */
abstract class BaseReciboPagoCompraFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('recibo_pago_compra_filters[%s]');
