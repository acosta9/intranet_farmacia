...
abstract class BaseFacturaCompraFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'estatus_oc'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'sumar_inv'         => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'estatus_oc'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'sumar_inv'         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
