...
/**
 * FacturaDet filter form base class.
 *
 ...
 */
abstract class BaseFacturaDetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('factura_det_filters[%s]');
