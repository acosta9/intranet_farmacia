...
/**
 * DevolverCompra filter form base class.
 *
 ...
 */
abstract class BaseDevolverCompraFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('devolver_compra_filters[%s]');
