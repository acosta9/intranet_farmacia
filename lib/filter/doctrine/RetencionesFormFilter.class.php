 ...
 */
class RetencionesFormFilter extends BaseRetencionesFormFilter
{
  public function configure()
  {
    ...
    $this->setWidget('comprobante', new sfWidgetFormFilterInput(array('with_empty' => false)));
    ...
    $this->widgetSchema['comprobante']->setAttributes(array('class' => 'form-control'));
