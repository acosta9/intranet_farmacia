 ...
 */
class InvAjusteFormFilter extends BaseInvAjusteFormFilter
{
  public function configure()
  {
    ...
    $this->setWidget('anulado', new sfWidgetFormChoice(array('choices' => array('' => '', 1 => 'PROCESADO', 0 => 'ANULADO'))));
