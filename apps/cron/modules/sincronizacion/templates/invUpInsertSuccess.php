<?php
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => "http://$domain/api.php/inventario/getFecha?eid=$eid&tipo=createdat",
  ...
  $results = $q->execute("SELECT * FROM inventario WHERE empresa_id=$eid && created_at>'$fecha'");
