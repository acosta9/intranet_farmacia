   ...
   <div class="page-title page-title-default title-size-default title-design-centered color-scheme-light" style="#background-color: #4c2d95">
		<div class="container">
			<header class="entry-header">
				<h1 class="entry-title">FACTURAS DE COMPRA</h1>
				<div class="breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">
					<a href="<?php echo url_for("@inicio"); ?>" rel="v:url" property="v:title">Inicio</a> » 
               <a href="<?php echo url_for("@factura"); ?>" rel="v:url" property="v:title">Facturas</a> » 
               <span class="current">Factura #<?php echo $factura->getNumFactura(); ?></span>
				</div>
			</header>
		</div>
	</div>
   <div class="container">
      <div class="invoice p-3 mb-3" id="invoice" <?php if($form->getObject()->get('estatus')==4) { echo 'style="background: #f1daa759 !important; padding: 1rem"'; } else { echo 'style="background: #fff !important; padding: 1rem"'; }?>>
         <div class="row">
            <div class="col-6">
            <h4>
               ...
               <table class="table">
                  ...
                  <tr>
                     ...
                     <td style="text-align: right">
                        <?php echo "USD ".number_format($subtotal=number_float($form->getObject()->get('subtotal')), 2, '.', ' ');?>
                     </td>
                  </tr>
                  <tr>
                     <td style="text-align: right"><b>DESCUENTO</b></td>
                     <td style="text-align: right">
                        <?php echo "% ".number_format($desc=number_float($form->getObject()->get('descuento')), 2, '.', ' ');?>
                     </td>
                     <td style="text-align: right">
                        <?php echo "USD ".number_format(($desc*$subtotal)/100, 2, '.', ' ');?>
                     </td>
                     <td style="text-align: right">
                        <?php echo "USD ".number_format(number_float($form->getObject()->get('subtotal_desc')), 2, '.', ' ');?>
                     </td>
                  </tr>
                  <tr>
                     <td style="text-align: right"><b>IVA</b></td>
                     <td style="text-align: right">
                        <?php echo "% ".number_format(number_float($form->getObject()->get('iva')), 2, '.', ' ');?>
                     </td>
                     <td style="text-align: right">
                        <?php echo "USD ".number_format(number_float($form->getObject()->get('base_imponible')), 2, '.', ' ');?>
                     </td>
                     <td style="text-align: right">
                        <?php echo "USD ".number_format(number_float($form->getObject()->get('iva_monto')), 2, '.', ' ');?>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td></td>
                     <td></td>
                     <td style="text-align: right"><?php echo "USD ".number_format(number_float($form->getObject()->get('total')), 2, '.', ' ');?></td>
                  </tr>
                  </tbody>
               </table>
            </div>
            ...
            <div class="col-12 table-responsive">
               <table class="table table-striped">
                  ...
                  <tr>
                     <td style="vertical-align: middle">
                        <?php
                        if($ocid=$form->getObject()->get('orden_compra_id')) {
                        echo "<a href='".url_for("orden_compra")."/show?id=".$ocid."'>".str_pad((string)$ocid, 8, "0", STR_PAD_LEFT)."</a>";
                        } else {
                     ...
                     <td style="vertical-align: middle">
                        <?php
                        if($form->getObject()->get('nota_entrega_id')) {
                        echo "<a href='".url_for("nota_entrega")."/show?id=".$ne->getId()."'>".$ne->getNcontrol()."</a>";
                        } else {
                        echo "<i class='fas fa-minus-circle'></i>";
                        }?>
                     </td>
            ...
            <div class="row">
               <div class="col-md-4">
                  ...
                  <div class="card" <?php if($result["anulado"]==1) { echo 'style="background: #f1daa759 !important;"'; }?>>
                     <div class="card-header" style="background-color: #add301;">
                        <h3 class="card-title">
