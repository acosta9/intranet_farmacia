    ...
    <tfoot>
      <tr>
        <td>
          ...
          <?php echo link_to(__('Limpiar ', array(), 'sf_admin'), 'producto_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'button', 'style' => '')) ?>
        ...
        <td style="border-top: none; padding-top: 0px; padding-bottom: 30px;">
          <div class="woodmart-woocommerce-layered-nav-17">
            <div id="wd-widget-stock-status-2" class="woodmart-widget widget sidebar-widget wd-widget-stock-status" style="margin-top: 1rem;">
              ...
              <ul>
                <li><a href="<?php echo url_for("producto")?>?sort=precio_usd_1&sort_type=desc" class=""> Mayor a Menor </a></li>
                <li><a href="<?php echo url_for("producto")?>?sort=precio_usd_1&sort_type=asc" class=""> Menor a Mayor </a></li>
              </ul>
            </div>
          </div>
        </td>
