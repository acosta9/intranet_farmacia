<table style="border-spacing: 0px; width: 100%;">
  <thead>
    ...
    <tr style="font-size: 11px !important">
      ...
      <td class="bbottom tleft"><b>TELF. SECUNDARIO</b></td>
  ...
  <tbody>
    ...
    foreach ($proveedors as $proveedor) { ?>
      <tr style="font-size: 11px !important" >
        ...
        <td colspan="2" class="bbottom tleft tcaps" ><?php echo mb_strtolower($proveedor->getFullName());?></td>
        <td class="bbottom tleft"><?php echo $proveedor->getDocId(); ?></td>
        <td class="bbottom tleft"><?php echo mb_strtolower($proveedor->getTelf()); ?></td>
        <td class="bbottom tleft"><?php echo mb_strtolower($proveedor->getCelular()); ?></td>
        <td colspan="2" class="bbottom tleft"><?php echo mb_strtolower($proveedor->getEmail());?></td>
      </tr>
    <?php   } ?>
  </tbody>
</table>
