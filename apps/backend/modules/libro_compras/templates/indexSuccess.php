<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Libro de Compras  <small style="font-size: 60%;"> filtros </small></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo url_for("@homepage"); ?>">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="<?php echo url_for("libro_compras"); ?>">Libro de Compras </a></li>
      ...
      <div class="card-body">
        <form action="#" method="post" id="form_filter">
          ...
          <div class="row float-sm-right">
            <a class="btn btn-default" href="<?php echo url_for("libro_compras"); ?>">LIMPIAR BUSQUEDA</a>
...
<script type="text/javascript">
  ...
  $("#form_filter").submit(function( event ) {
    ...
    window.open("<?php echo url_for("libro_compras")."/reporte"?>?eid="+eid+"&desde="+desde+"&hasta="+hasta, '_blank');
