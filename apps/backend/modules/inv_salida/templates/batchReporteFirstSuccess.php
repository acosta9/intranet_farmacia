<?php
  $value = array();
  $i=0;
  foreach ($inv_salidas as $inv_salida):
    $value[$i]=$inv_salida["id"];
    $i++;
  endforeach;
?>
  ...
  <table style="border-spacing: 0px; width: 100%;" id="tabla_export">
    <thead>
      <tr>
        <td colspan="12" style="text-align: center; text-decoration: underline;">
          <p style="margin-top: 0px !important">
            <b>REPORTE DE SALIDA DE INVENTARIO</b>
      ...
      <tr style="">
        ...
        <td class="bbottom tleft"><b>SALIDA</b></td>
