    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <select name="nota_entrega[nota_entrega_det][<?php echo $num?>][inventario_id]" class="form-control nota_entrega_det_inventario_id" id="nota_entrega_nota_entrega_det_<?php echo $num?>_inventario_id">
          </select>
        </div>
        <div class="col-md-4">
          <div class="form-group">
      ...
      <div class="col-md-1">
        ...
        <div class="form-group">
          <input class="form-control max_item" name="max_item" readonly id="nota_entrega_nota_entrega_det_<?php echo $num; ?>_max_item">
        </div>
      </div>
      <div class="col-md-2">
...
<div><div><div>
<script>
  var select = document.getElementById("nota_entrega_nota_entrega_det_<?php echo $num; ?>_inventario_id");
  ...
  $(function () {
    ...
    sumar();
    $("#nota_entrega_nota_entrega_det_<?php echo $num; ?>_inventario_id").on('change', function(event){
      item_prod(<?php echo $num; ?>);
      sumar();
    });

    $("#nota_entrega_nota_entrega_det_<?php echo $num; ?>_inventario_id").select2({ width: '100%'});
