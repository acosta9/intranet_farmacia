...
<?php
  $cajac=Doctrine_Core::getTable('CajaCorte')->findOneBy('id',$sf_params->get('idz'));
  $caja=Doctrine_Core::getTable('Caja')->findOneBy('id',$cajac->getCajaId());
  $empresa=Doctrine_Core::getTable('Empresa')->findOneBy('id',$caja->getEmpresaId());
  $fe=substr($cajac->getFechaIni(), 0,10);
...
<div class="invoice p-3 mb-3" id="invoice">
 ...
 <!-- <div class="card card-primary" id="datos">-->
    <!-- <div class="card-body">-->
       <div class="row">
         <div class="col-md-11">
          <h3 style="text-align: center;">Informe de Ventas <?php echo $caja->getNombre();  ?> del día: <?php echo $fecha;  ?> </h3>
         </div><br></div>
     <!-- </div> -->
      <div class="row">
        <div class="col-11 table-responsive-sm">
          ...
          <tbody>
         <?php $ausd=0; $abs=0; $i=0; $a10001=0;$a10002=0; $a10003=0;$a10004=0;$a10005=0;$a10006=0;$a10011=0;$a10012=0;$a10013=0;$monto2=0;
          $anuusd=0; $anubs=0;$monto=0;$montobs=0;
          $cxcs = Doctrine_Query::create()
                    ...
                    ->andWhere('f.caja_id = ?', $cajac->getCajaId())
                    ->orderBy('cc.id ASC')
                    ->execute(); 
                   foreach ($cxcs as $cxc) { 
        ...
        // si cxc estatus == 4 debo colocarlo tachado y no totalizar o totalizar ese monto
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td><b>Otros </b><?php echo number_format($a10013, 4, ',', '.');   ?></td>
              <td colspan="3"></td>
            </tr>
            <tr>
