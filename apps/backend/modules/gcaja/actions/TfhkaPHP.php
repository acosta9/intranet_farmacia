<?php
// ../apps/backend/modules/pventa/actions/
set_time_limit(1200);
class Tfhka
{
...
{
$sentencia = "/IntTFHKA/IntTFHKA.exe CheckFprinter()";

shell_exec($sentencia);

$rep = ""; 
$repuesta = file('/IntTFHKA/Retorno.txt');
...
{
$sentencia = "/IntTFHKA/IntTFHKA.exe SendCmd(".$cmd;
...
$sentencia = "/IntTFHKA/IntTFHKA.exe ReadFpStatus()";


shell_exec($sentencia);

$rep = ""; 
$repuesta = file('/IntTFHKA/status_error.txt');
...
$sentencia = "/IntTFHKA/IntTFHKA.exe SendFileCmd(".$ruta;
...
$repuesta = file('/IntTFHKA/Retorno.txt');
//$repuesta = file('Retorno.txt');
//$repuesta = file('C:\xampp\htdocs\jmw\apps\backend\modules\pventa\actions\Retorno.txt');
$lineas = count($repuesta);
for($i=0; $i < $lineas; $i++)
{
 $rep = $repuesta[$i];
...
$sentencia = "/IntTFHKA/IntTFHKA.exe UploadStatusCmd(".$cmd." ".$file;

shell_exec($sentencia);

$repStErr = ""; 
$repuesta = file('/IntTFHKA/StatusData.txt');
...
$sentencia = "/IntTFHKA/IntTFHKA.exe UploadReportCmd(".$cmd." ".$file;
