...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Banners <small style="font-size: 60%;">listado</small></h1>
      </div>
      <div class="col-sm-6">
  ...
  <section class="content" id="filtros" style="display: none">
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-body">
          <?php include_partial('banners/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header" style="padding: 0.75rem 1.25rem 0rem 1.25rem">
        <div class="row">
          <div class="col-md-2 col-sm-12">
              <?php include_partial('banners/list_actions', array('helper' => $helper)) ?>
          </div>
          <div class="col-md-10 col-sm-12">
            <div class="row float-sm-right">
              <div class="filter">
                <?php include_partial('banners/list_batch_actions', array('helper' => $helper)) ?>
              </div>
              <div class="filter">
              ...
              <div>
                <?php include_partial('banners/pagination_list_select', array( 'pager' => $pager)) ?>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-body table-responsive p-0" style="border-bottom: 1px solid rgba(0,0,0,.125);">
        <?php include_partial('banners/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
      </div>
      <div class="row mt-2 mb-2">
        ...
        <div class="col-sm-12 col-md-7">
          <?php if ($pager->haveToPaginate()): ?>
            <?php include_partial('banners/pagination', array('pager' => $pager)) ?>
          <?php endif; ?>
        </div>
      </div>
    </div>
